  ...
  return (
    <Layout>
      ...
      <section className="relative overflow-hidden py-24 md:py-32">
        ...
        <div className="absolute top-10 right-20 w-80 h-80 bg-neon-pink/10 rounded-full blur-3xl animate-blob" />
        <div className="absolute bottom-10 left-10 w-64 h-64 bg-neon-purple/10 rounded-full blur-3xl animate-blob" style={{ animationDelay: "4s" }} />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {featured.map((item, i) => (
                <motion.a
                  ...
                  className="group rounded-2xl border-2 border-neon-pink/30 bg-card overflow-hidden cursor-pointer"
                >
                  <div className="aspect-video bg-gradient-to-br from-neon-pink/20 to-neon-purple/20 flex items-center justify-center relative">
                    {item.thumbnail_url ? (
                      ...
                      <Play className="h-12 w-12 text-neon-pink opacity-50 group-hover:opacity-100 group-hover:scale-125 transition-all" />
                    )}
      ...
      <section className="py-10 pb-20">
        <div className="container mx-auto px-4">
          <h2 className="font-display text-2xl font-bold mb-8 flex items-center gap-2">
            <Eye className="h-6 w-6 text-neon-cyan" /> Tous les contenus
          </h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {rest.map((item, i) => (
              <motion.a
                ...
                className="group rounded-xl border border-border/50 bg-card p-5 hover:border-neon-cyan/40 transition-all cursor-pointer"
              >
