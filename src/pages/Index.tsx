...
const stats = [
  { label: "Membres", value: "10K+", icon: Users },
  { label: "Vidéos TikTok", value: "500+", icon: TrendingUp },
  { label: "Astuces partagées", value: "1K+", icon: Zap },
];
    ...
    <Layout>
      ...
      <section className="relative overflow-hidden py-24 md:py-36">
        ...
        <div className="container mx-auto px-4 text-center relative">
          ...
          >
            Bienvenue chez{" "}
            <span className="text-gradient">Astuceson</span>
          </motion.h1>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            TikTokeur passionné, je partage les meilleures astuces du web. 
            Rejoins ma communauté Discord pour ne rien rater !
          </motion.p>
          <motion.div
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <h2 className="font-display text-3xl md:text-4xl font-bold text-center mb-14">
            Pourquoi rejoindre <span className="text-gradient">Astuceson</span> ?
          </h2>
        ...
        <div className="container mx-auto px-4">
          <div className="rounded-2xl bg-gradient-to-r from-neon-cyan/10 to-neon-pink/10 border border-border/50 p-10 md:p-16 text-center">
            ...
            <p className="text-muted-foreground mb-8 max-w-lg mx-auto">
              Des milliers de personnes font déjà partie de la communauté Astuceson. N'attends plus !
            </p>
            <a href="#" target="_blank" rel="noopener noreferrer">
